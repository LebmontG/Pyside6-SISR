'''
Swin-Transformer for image super-rusolution
2022.5.21 Z.Gan
'''
...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='weights/003_realSR_BSRGAN_DFO_s64w8_SwinIR-M_x4_GAN.pth')
...
def setup(args):
    ...
    if args.task in ['classical_sr', 'lightweight_sr']:
        #save_dir = f'res/swinir_{args.task}_x{args.scale}'
        save_dir ='res'
        folder ='data'
        border = args.scale
        window_size = 8
